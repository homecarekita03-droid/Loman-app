// ============================================
// 📊 LOMAN — Laporan Pendapatan Penjual
// ============================================
// Jalankan: node tambah-laporan.js
// ============================================
...
console.log("");
console.log("📊 ========================================");
console.log("   Tambah Laporan Pendapatan Penjual");
console.log("========================================");
console.log("");
...
// =============================================
writeFile("app/seller/laporan/page.js", `
"use client";
...
// =============================================
// UPDATE SELLER DASHBOARD — Tambah link Laporan
// =============================================
const dashPath = "app/seller/page.js";
if (fs.existsSync(dashPath)) {
  let content = fs.readFileSync(dashPath, "utf-8");

  // Ganti quick action "Pengaturan" menjadi "Laporan" dan tambah Pengaturan
  if (!content.includes("/seller/laporan")) {
    content = content.replace(
      '{icon:"⚙️",label:"Edit Toko",path:"/seller/toko-setting"},',
      '{icon:"📊",label:"Laporan",path:"/seller/laporan"},\n          {icon:"⚙️",label:"Edit Toko",path:"/seller/toko-setting"},'
    );

    // Ubah grid dari 4 ke 5 kolom (atau biarkan wrap)
    content = content.replace(
    ...
    console.log("  ✅ " + dashPath + " (link Laporan ditambahkan)");
  }
}

console.log("");
console.log("🎉 ========================================");
console.log("   LAPORAN PENDAPATAN SELESAI!");
console.log("========================================");
console.log("");
console.log("   📊 FITUR LAPORAN:");
console.log("   ✅ Filter: Hari Ini / 7 Hari / Bulan Ini / Semua");
console.log("   ✅ Total Pendapatan (selesai + pending)");
console.log("   ✅ Total Pesanan & rata-rata per pesanan");
console.log("   ✅ Grafik batang pendapatan harian");
console.log("   ✅ Produk Terlaris (top 5 dengan medal)");
console.log("   ✅ Pelanggan Setia (top 5)");
console.log("   ✅ Riwayat Transaksi lengkap");
console.log("   ✅ Shortcut dari Dashboard (tombol 📊 Laporan)");
console.log("");
console.log("   ⚠️  PENTING: Tambahkan domain di Firebase!");
console.log("   Firebase Console → Authentication → Settings");
console.log("   → Authorized domains → Add:");
console.log("   - loman.store");
console.log("   - www.loman.store");
console.log("");
console.log("   Jalankan: npm run dev");
console.log("   Deploy:  git add . && git commit -m 'laporan + fix login' && git push");
console.log("");
